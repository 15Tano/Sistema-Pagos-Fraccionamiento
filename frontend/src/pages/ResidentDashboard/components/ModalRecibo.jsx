...
export default function ModalRecibo({ isOpen, isVisible, onClose, pago }) {
        ...
        >
            ...
            >
                <div className="flex items-center justify-between p-5 border-b border-white/30 shrink-0">
                    <h3 className="text-lg font-bold text-stone-800">Recibo de pago</h3>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 overflow-y-auto">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-xs text-stone-400 mt-1">
                            No. de recibo: {String(pago.id).padStart(6, "0")}
                        </p>
                    </div>
                    ...
                    <div className="space-y-3 text-sm">
                        <div className="flex justify-between">
                            <span className="text-stone-500 font-semibold">Mes pagado</span>
                            <span className="text-stone-800 font-bold capitalize text-right">
                                {formatMonth(pago.mes)}
                            </span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-stone-500 font-semibold">Tipo</span>
                            <span className="text-stone-800 font-bold capitalize text-right">
                                {pago.tipo}
                            </span>
                        </div>
                        <div className="flex justify-between">
                            <span className="text-stone-500 font-semibold">Fecha de pago</span>
                    ...
                    <div className="flex justify-between items-center">
                        <span className="text-sm font-bold text-stone-600">Total pagado</span>
